...
@section('contenido')
 <div class="container mx-auto md:flex">
    <div class="md:w-1/2">
        ...
        <div>
            <p class="fount-bold"> {{ $post->user->username}} </p>
    ...
    <div class="md:w-1/2 p-5">
        <div class="shadow bg-whire p-5 mb-5">
            @auth
                ...
                <form action="{{ route('comentarios.store', ['post' => $post , 'user' => $user]) }}" method="POST" >
                    ...
                    <textarea id="comentario" name="comentario" placeholder="Agrege un comentario" class="border p-3 w-full rounded-lg @error('comentario') border-red-500 @enderror">{{ old('comentario') }}</textarea>
                    @error('comentario')
            ...
            <div class="bg-white shadow mb-5 max-h-96 overflow-y-scroll mt-10">
                @if ($post->comentarios->count())
                    @foreach ($post->comentarios as $comentario)
                        <div clas="p-5 border-gray-300 border-b">
